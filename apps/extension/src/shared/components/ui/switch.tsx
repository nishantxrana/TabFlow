...
/**
 * Switch component with warm, satisfying feel
 * - Slightly larger for better accessibility
 * - Smooth transitions
 * - Warm accent color when active
 */
...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-primary-500 data-[state=unchecked]:bg-stone-200 dark:data-[state=unchecked]:bg-stone-700",
      className
    )}
    {...props}
    ref={ref}
